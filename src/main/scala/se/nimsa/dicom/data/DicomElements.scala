...
import se.nimsa.dicom.data.DicomParsing.multiValueDelimiter
import se.nimsa.dicom.data.TagPath.TagPathTrunk
...
object DicomElements {
  ...
  trait PreambleElement extends DicomElement

  trait DataElement extends DicomElement

  trait SequenceElement extends DicomElement

  trait FragmentsElement extends DicomElement

  trait ItemElement extends DicomElement
